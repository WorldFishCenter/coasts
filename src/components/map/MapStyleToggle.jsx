...
const MapStyleToggle = memo(({ isDarkTheme, isSatellite, onToggle }) => {
  return (
    <button
      ...
      className="w-12 h-12 p-2 glass-panel rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/10 group cursor-pointer"
    >
